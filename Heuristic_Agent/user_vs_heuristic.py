...
if __name__ == "__main__" :
	...
	agent = Heuristic_Agent(5, timeout=6, pruning=True, t_table=t_table, node_ordering=True, it_deepening=True, verbose=False)
	start_game("user", agent, board=chess.Board("4k3/pppp4/8/8/8/8/PPPP4/3K4 w - - 0 1"))
